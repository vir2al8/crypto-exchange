...
fun validationOperationCorrect(command: CommonCommand, processor: OrderProcessor) = runTest {
...
@OptIn(ExperimentalCoroutinesApi::class)
fun validationOperationNone(command: CommonCommand, processor: OrderProcessor) = runTest {
    val ctx = CommonContext(
        command = command,
        state = CommonState.NONE,
        workMode = CommonWorkMode.TEST,
