...
import com.crypto.cor.handlers.CorChain
import com.crypto.cor.handlers.CorWorker
import com.crypto.cor.handlers.executeSequential
...
class CorBaseTest {
    ...
    @Test
    fun `handle should execute`() = runBlocking {
    ...
    @Test
    fun `on should check condition`() = runBlocking {
    ...
    @Test
    fun `except should execute when exception`() = runBlocking {
    ...
    @Test
    fun `except should throw when exception and no except`(): Unit = runBlocking {
        assertFails {
            execute(rootChain {
